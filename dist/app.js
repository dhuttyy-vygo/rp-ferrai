...
(()=>{
    var textToSplit = function() {
        ...
        el.forEach((text)=>{
            new (0, _splitTypeDefault.default)(text, {
                types: "words",
                wordClass: "wordsin"
            });
        });
        ...
        textInline.forEach((words)=>{
            new (0, _splitTypeDefault.default)(words, {
                types: "words",
                wordClass: "words-card"
            });
        });
    };
    var preLoad = function() {
        // prealoading animation //
        const logo = document.querySelector(".fr-logo-preload"), backdrop = document.querySelector(".fr-preloader"), title = document.querySelectorAll(".wordsin");
        var tl = Qe.timeline();
        tl.set(logo, {
            autoAlpha: 0
        });
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        t.addEventListener("click", function() {
            ...
            e.pause(), e.currentTime = 0, (0, _gsap.gsap).to(o, {
                autoAlpha: 0,
                duration: 0.3,
                ease: "power1.easeInOut"
            });
        ...
        setTimeout(()=>{
            $("[data-animate-in]").each(function(index) {
                ...
                let tl;
                function splitText() {
                    new (0, _splitTypeDefault.default)(textEl, {
                        types: "words",
                        tagName: "span"
                    });
        ...
        function initializeSwiper() {
            ...
            marquee.forEach((e)=>{
                const items = e.querySelector(".fr-marquee-items"), item = e.querySelectorAll(".fr-marquee-item");
...
},{"reeller":"22NRl","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","swiper":"iM6UL","split-type":"fvGAG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"22NRl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./ssr-window.esm.mjs":"th8PY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fvGAG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hPIHA","igcvL"], "igcvL", "parcelRequirec48f")
